...
<div class="web_paht">
    <div class="row_l web_paht_l">您的位置：人才考核&nbsp;&gt;&nbsp;人才资源统计内容
    </div>
         ...
         <form action="<%=path%>/soa/rcgzkh!saveOrupdateTong.action?menuId=" method="post" name="frm" id="frm">
              ...
              <table style="font-size: 15">
                ...
                <td colspan="3" align="left"><select style="width:90px" id="year" name="form.rsRczytjnr.year"></select></td>                       
              	<tr><td colspan="4"><h2>全市人才资源统计内容及任务分工</h2></td></tr>
              	<tr>
	            ...
	            <input id="pk" type="hidden" name="form.rsRczytjnr.pk" value="<s:property value="form.rsRczytjnr.pk"/>"/>
		            ...
		            <tr>
		            	...
		            	<td nowrap="nowrap"><input id="rczyzl" readonly="readonly" class="readabled" name="form.rsRczytjnr.rczyzl" type="text"  value="<s:property value="form.rsRczytjnr.rczyzl"/>" class="inp" style="width:98%;" /></td>	              	
		            </tr>
		            ...
		            <tr>
		            	...
		            	<td nowrap="nowrap"><input id="rczybl" readonly="readonly" class="readabled" name="form.rsRczytjnr.rczybl" type="text"  value="<s:property value="form.rsRczytjnr.rczybl"/>" class="inp" style="width:98%;" /></td>	              	
		            </tr>
		            <tr>
		            	<td nowrap="nowrap">7</td>
		            	<td nowrap="nowrap" colspan="2" align="left">党政、企业经营管理和专业技术人才中大学本科及以上学历<br />人员所占比例</td>
		            	<td nowrap="nowrap"><input id="bkysxlbl" readonly="readonly" class="readabled" name="form.rsRczytjnr.bkysxlbl" type="text"  value="<s:property value="form.rsRczytjnr.bkysxlbl"/>" class="inp" style="width:98%;" /></td>	              	
		            </tr>
		            <tr>
		            ...
		            <tr>
		            	...
		            	<td nowrap="nowrap"><input id="ncsyrcjynx" readonly="readonly" class="readabled" name="form.rsRczytjnr.ncsyrcjynx" type="text"  value="<s:property value="form.rsRczytjnr.ncsyrcjynx"/>" class="inp" style="width:98%;" /></td>	              	
		            </tr>
		            <tr>
		            ...
		            <tr>
		            	...
		            	<td nowrap="nowrap"><input id="hdgjjjlsl" readonly="readonly" class="readabled" onblur="checkData(this);"  name="form.rsRczytjnr.hdgjjjlsl" type="text"  value="<s:property value="form.rsRczytjnr.hdgjjjlsl"/>" class="inp" style="width:98%;" /></td>	              	
		            </tr>
		            <tr>
		            ...
		            <tr>
		            	...
		            	<td nowrap="nowrap"><input id="dzrczl" readonly="readonly" class="readabled" onblur="checkData(this);" name="form.rsRczytjnr.dzrczl" type="text"  value="<s:property value="form.rsRczytjnr.dzrczl"/>" class="inp" style="width:98%;" /></td>	              	
		            </tr>
		            <tr>
		            	<td nowrap="nowrap">26</td>
		            	<td nowrap="nowrap" align="left">副科以上干部人数</td>
		            	<td nowrap="nowrap"><input id="dzrcfkjzl" readonly="readonly" class="readabled"  name="form.rsRczytjnr.dzrcfkjzl" type="text"  value="<s:property value="form.rsRczytjnr.dzrcfkjzl"/>" class="inp" style="width:98%;" /></td>	              	
		            </tr>
		            <tr>
		            	<td nowrap="nowrap">27</td>
		            	<td nowrap="nowrap" align="left">大学本科及以上学历人数及比例</td>
		            	<td nowrap="nowrap"><input id="dzbkysrsbl" readonly="readonly" class="readabled"  onblur="checkData(this);" name="form.rsRczytjnr.dzbkysrsbl" type="text"  value="<s:property value="form.rsRczytjnr.dzbkysrsbl"/>" class="inp" style="width:98%;" /></td>	              	
		            </tr>
		            <tr>
		            ...
		            <tr>
		            	...
		            	<td nowrap="nowrap" align="left">总量</td>
		            	<td nowrap="nowrap"><input id="qyrczl" readonly="readonly" class="readabled" name="form.rsRczytjnr.qyrczl" type="text"  value="<s:property value="form.rsRczytjnr.qyrczl"/>" class="inp" style="width:98%;" /></td>	              	
		            </tr>
		            <tr>
		            	<td nowrap="nowrap">30</td>
		            	<td nowrap="nowrap" align="left">大学本科及以上学历人数及比例</td>
		            	<td nowrap="nowrap"><input id="qybkysszbl" readonly="readonly" class="readabled" name="form.rsRczytjnr.qybkysszbl" type="text"  value="<s:property value="form.rsRczytjnr.qybkysszbl"/>" class="inp" style="width:98%;" /></td>	              	
		            </tr>
		            <tr>
		            ...
		            <tr>
		            	...
		            	<td nowrap="nowrap"><input id="qyzcyrcbl" readonly="readonly" class="readabled" name="form.rsRczytjnr.qyzcyrcbl" type="text"  value="<s:property value="form.rsRczytjnr.qyzcyrcbl"/>" class="inp" style="width:98%;" /></td>	              	
		            </tr>
		            <tr>
		            	<td nowrap="nowrap">35</td>
		            	<td nowrap="nowrap" rowspan="5"  width="50px">专业技<br />术人才</td>
		            	<td nowrap="nowrap"  width="150px" align="left">总量</td>
		            	<td nowrap="nowrap"><input id="zyjszl" readonly="readonly" class="readabled" name="form.rsRczytjnr.zyjszl" type="text"  value="<s:property value="form.rsRczytjnr.zyjszl"/>" class="inp" style="width:98%;" /></td>	              	
		            </tr>
		            <tr>
		             ...
		             <tr>
		            	...
		            	<td nowrap="nowrap" align="left">大学本科及以上学历人数及比例</td>
		            	<td nowrap="nowrap"><input id="zybkjysbl" readonly="readonly" class="readabled" name="form.rsRczytjnr.zybkjysbl" type="text"  value="<s:property value="form.rsRczytjnr.zybkjysbl"/>" class="inp" style="width:98%;" /></td>	              	
		            </tr>
		             <tr>
		            	<td nowrap="nowrap">38</td>
		            	<td nowrap="nowrap" align="left">占从业人员的比例及</td>
		            	<td nowrap="nowrap"><input id="zyzcyrcbl" readonly="readonly" class="readabled"  name="form.rsRczytjnr.zyzcyrcbl" type="text"  value="<s:property value="form.rsRczytjnr.zyzcyrcbl"/>" class="inp" style="width:98%;" /></td>	              	
		            </tr>
		             <tr>
		             ...
		             <tr>
		            	...
		            	<td nowrap="nowrap" align="left">总量</td>
		            	<td nowrap="nowrap"><input id="rlzyzhslzs" readonly="readonly" class="readabled" name="form.rsRczytjnr.rlzyzhslzs" type="text"  value="<s:property value="form.rsRczytjnr.rlzyzhslzs"/>" class="inp" style="width:98%;" /></td>	              	
		            </tr>
		             <tr>
		             ...
		             <tr>
		            	...
		            	<td nowrap="nowrap" align="left">总量</td>
		            	<td nowrap="nowrap"><input id="ncrczl" readonly="readonly" class="readabled" name="form.rsRczytjnr.ncrczl" type="text"  value="<s:property value="form.rsRczytjnr.ncrczl"/>" class="inp" style="width:98%;" /></td>	              	
		            </tr>
		             <tr>		   
		             ...
		             <tr>
		            	...
		            	<td nowrap="nowrap" align="left">总量</td>
		            	<td nowrap="nowrap"><input id="shgzzl" readonly="readonly" class="readabled" name="form.rsRczytjnr.shgzzl" type="text"  value="<s:property value="form.rsRczytjnr.shgzzl"/>" class="inp" style="width:98%;" /></td>	              	
		            </tr>
		             <tr>
		             ...
		             <tr>
		            	...
		            	<td nowrap="nowrap"><input id="jyfgrcsl" readonly="readonly" class="readabled" name="form.rsRczytjnr.jyfgrcsl" type="text"  value="<s:property value="form.rsRczytjnr.jyfgrcsl"/>" class="inp" style="width:98%;" /></td>	              	
		            </tr>
		            <tr>
		            	<td nowrap="nowrap">48</td>
		            	<td nowrap="nowrap" colspan="2" align="left">具有博士学位人才数量</td>
		            	<td nowrap="nowrap"><input id="jybsrcsl" readonly="readonly" class="readabled" name="form.rsRczytjnr.jybsrcsl" type="text"  value="<s:property value="form.rsRczytjnr.jybsrcsl"/>" class="inp" style="width:98%;" /></td>	              	
		            </tr>
		            <tr>
