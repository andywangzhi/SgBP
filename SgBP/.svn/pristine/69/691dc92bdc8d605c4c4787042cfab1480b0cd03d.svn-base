...
<jsp:include page="../inc/top.jsp"></jsp:include>
    ...
    <script type="text/javascript" src="<%=path%>/js/system/role/list.js"></script>				
</head>
<div class="main_in">
          ...
          <div  border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
              <table cellpadding=3>
                  <tr>
                      ...
                      <td><input type="text" id="search_name" name="search_name"  style="width:100px;"/></td>
                      <td style="text-align: right; font-size:12px;">描述</td>
                      <td><input type="text" id="search_remark" name="search_remark"  style="width:100px;"/></td>
                      <td style="text-align: right; font-size:12px;">用户组</td>
                      <td>
	                     <select id="search_groupId" name="search_groupId" style="width:100px;">
	                       <option value="">全部</option>
	                     </select>
                      </td>
                      <td style="text-align: right; font-size:12px;">状态</td>
                      <td>
	                     <select id="search_valid" name="search_valid"  style="width:100px;">
	                       <option value="">全部</option>
