...
public class ProjectExperienceServiceLocator extends org.apache.axis.client.Service implements com.gmcc.support.trade.service.provider.outrcsm.xmjy.ProjectExperienceService {
    ...
    public com.gmcc.support.trade.service.provider.outrcsm.xmjy.IProjectExperienceService getProjectExperienceServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.gmcc.support.trade.service.provider.outrcsm.xmjy.IProjectExperienceService getProjectExperienceServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.gmcc.support.trade.service.provider.outrcsm.xmjy.ProjectExperienceServiceSoapBindingStub _stub = new com.gmcc.support.trade.service.provider.outrcsm.xmjy.ProjectExperienceServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.gmcc.support.trade.service.provider.outrcsm.xmjy.IProjectExperienceService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.gmcc.support.trade.service.provider.outrcsm.xmjy.ProjectExperienceServiceSoapBindingStub _stub = new com.gmcc.support.trade.service.provider.outrcsm.xmjy.ProjectExperienceServiceSoapBindingStub(new java.net.URL(ProjectExperienceServicePort_address), this);
                _stub.setPortName(getProjectExperienceServicePortWSDDServiceName());
                return _stub;
            }
        }
