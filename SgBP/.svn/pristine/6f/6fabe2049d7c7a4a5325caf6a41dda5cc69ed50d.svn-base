  ...
  <head>
	...
	<script type="text/javascript">
		...
		function doUpdate(num){ 
			if(entrance==1){
				document.getElementById('ShowDiv').innerHTML ='请先在个人信息申报页面填写个人基本信息，系统将在&nbsp;&nbsp;&nbsp;&nbsp;<span>'+num+'</span>&nbsp;&nbsp;&nbsp;&nbsp;秒后自动跳转到个人信息申报页面！<br/><a href="javascript:goRightNow();">点此立刻跳转!</a>';
			}else{
				document.getElementById('ShowDiv').innerHTML ='请在人员信息维护页面选择需要维护信息的个人，系统将在&nbsp;&nbsp;&nbsp;<span>'+num+'</span>&nbsp;&nbsp;&nbsp;&nbsp;秒后自动跳转到个人信息维护页面！<br/><a href="javascript:goRightNow();">点此立刻跳转!</a>'; 
			}
			if(num == 0){
			 	window.location=URL; 
			} 
