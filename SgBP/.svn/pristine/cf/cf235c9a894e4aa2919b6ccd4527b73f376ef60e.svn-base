...
public class UserVo  implements java.io.Serializable {
    ...
    /**
     * Gets the birthDate value for this UserVo.
     * 
     * @return birthDate
     */
    ...
    /**
     * Sets the birthDate value for this UserVo.
     * 
     * @param birthDate
     */
    ...
    /**
     * Gets the status value for this UserVo.
     * 
     * @return status
     */
    ...
    /**
     * Sets the status value for this UserVo.
     * 
     * @param status
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://provider.service.trade.support.gmcc.com/", "userVo"));
