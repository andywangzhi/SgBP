...
<html>
	...
	<script language="JavaScript" src="<%=path%>/images/FusionCharts.js"></script>
	    ...
	    function find(){
			...
			$("#frm").attr("action","<%=path%>/soa/rctj!querySpecialtyType.action?menuId=<%=request.getParameter("menuId")%>");
			$("#frm").submit();
    	}
	...
	function ExportSpecialtyTypeExecl(){
	    ...
	    //	$.get("/soa/rctj!ExportPcountyExecl.action?ra="+ra,{"form.retrieveSO.pcounty":pcounty,"form.retrieveSO.forDate":fdate,"form.retrieveSO.todate":tdate});
    		$("#frm").attr("action","<%=path%>/soa/rctj!ExportSpecialtyTypeExecl.action?menuId=<%=request.getParameter("menuId")%>");
    		$("#frm").submit();
			}
...
$(document).ready(function(){
	...
	var _xmlSrc = "<chart caption='专业分布统计' xAxisName='"+_xAxisName+"' yAxisName='人才数量' showValues='0' decimals='0' formatNumberScale='0' baseFontSize='12' rotateYAxisName='0'>";
	_xmlSrc += _dataXML;
	_xmlSrc += "</chart>";
...
<div class="web_paht">
    <div class="row_l web_paht_l">您的位置：人才统计监控&nbsp;&gt;&nbsp;专业人才统计&nbsp;&gt;&nbsp;韶关市专业人才统计</div>
...
<div class="main_in">
         ...
         <form action="<%=path%>/soa/rctj!querySpecialtyType.action?menuId=<%=request.getParameter("menuId")%>" method="post" name="frm" id="frm">
                          ...
                          <tr>
                              ...
                              <td width="15%;" nowrap="nowrap">
                                  <select id="form.retrieveSO.pcounty" name="form.retrieveSO.pcounty" class="inp">
                                		...
                                		<s:iterator value="#application._WEB_SYS_CONF_KEY_.get(\"5\")">
                              ...
                              <th width="90px" nowrap="nowrap">时间段：</th>
              ...
              <div style=" margin-top:10px; border:1px #CCC dashed;overflow:hidden; clear:both">
                  <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0" width="800" height="328" align="middle">
                      ...
                      <param name="FlashVars" value="ntitle=统计项目&toggle=全部显示|全部隐藏&vtitle=数值&cnames=&datatype=300000&rtitle=专业公布&gtypes=bar|line|hbar|pie&uloc=cn|$|0|1|2|3|4|5|6&total=<s:property value="form.swf" />" />
                      <embed src="<%=path %>/images/category.swf" FlashVars="ntitle=统计项目&toggle=全部显示|全部隐藏&vtitle=数值&cnames=&datatype=300000&rtitle=专业公布&gtypes=bar|line|hbar|pie&uloc=cn|$|0|1|2|3|4|5|6&total=<s:property value="form.swf" />" quality="high" width="800" height="328" align="middle" wmode="transparent" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
                  </object>
              </div>
