              ...
              <div class="table_edit">
                  ...
                  <tbody>
                  	...
                  	<tr>
                  		...
                  		<td colspan="1">
                  			<select style="width:154px;" id="personType" name="form.queryListSO.personType" class="inp">
                  		...
                  		<td >
                  			<s:if test='#session._USER_LOGIN_.getUsertype()=="3" '>
	                  			<select style="width:100px;" id="unitlvl" name="form.queryListSO.unitlvl" class="inp">
		                  				<option value="3">单位所属：县（市、区）单位</option>
	                  				</select>
                  			</s:if>
                  			
                  			<s:else>
                  				<select style="width:155px;" id="unitlvl" name="form.queryListSO.unitlvl"   class="inp" >
	                  				<option value="">请选择</option>
