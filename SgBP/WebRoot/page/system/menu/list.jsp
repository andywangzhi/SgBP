...
<jsp:include page="../inc/top.jsp"></jsp:include>
    ...
    <script type="text/javascript" src="<%=path%>/js/system/menu/list.js"></script>	
</head>
<div class="main_in">
          ...
          <div  border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
              <table cellpadding=3>
                  <tr>
                      ...
                      <td><input type="text" id="search_code" name="search_code" style="width:100px;"/></td>
                      ...
                      <td>
	                     <select id="search_type" name="search_type" style="width:100px;">
