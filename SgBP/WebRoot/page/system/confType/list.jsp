...
<title>字典列表</title>
    ...
    <script type="text/javascript" src="<%=path%>/js/system/confType/list.js"></script>
</head>
<div class="main_in">
          ...
          <div  border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
              <table cellpadding=3>
                  <tr>
                      ...
                      <td ><input type="text" id="search_code" name="search_code" style="width:120px;"/></td>
                      <td  style="text-align: right; font-size:12px;">名称</td>
                      <td ><input type="text" id="search_name" name="search_name" style="width:120px;"/></td>
