...
<link rel="stylesheet" type="text/css" href="<%=path%>/business/css/reset.css" />
    	...
    	$(function(){
	    	...
	    	function getRest() {
	    		...
	    		document.getElementById('techassessforDate').value = '';
	    		document.getElementById('techassesstoDate').value = '';
	    		document.getElementById('pquarters').value = '';
	    		document.getElementById('unitlvl').value = '';
	    		document.getElementById('harvestLevel').value = '';
	    		document.getElementById('harvestassesstoDate').value = '';
                  ...
                  <table>
                      <tbody>
                          ...
                          <%} %>
                               ...
                               <td width="15%;" nowrap="nowrap">
	                              <select name="form.retrieveSO.psex" class="inp"" id="psex">
                              ...
                              <td width="15%;" nowrap="nowrap">
	                              <select id="cultureType" name="form.retrieveSO.cultureType" class="inp"">
	                              	  <option value="">请选择</option>
                          ...
                          <th width="90px" nowrap="nowrap">所在行业：</th>
                              <td width="15%;" nowrap="nowrap">
	                              <select id="ptrade" name="form.retrieveSO.ptrade" class="inp"">
	                              	  <option value="">请选择</option>
                          ...
                          <th width="90px" nowrap="nowrap">单位性质：</th>
                              <td width="15%;" nowrap="nowrap">
	                              <select id="economykind" name="form.retrieveSO.economykind" class="inp"">
	                              	  <option value="">请选择</option>
                              ...
                              <td width="15%;" nowrap="nowrap">
	                              <select id="technicallyLevel" name="form.retrieveSO.technicallyLevel" class="inp"">
	                              	  <option value="">请选择</option>
                          ...
                          <tr>
                              ...
                              <td width="15%;" nowrap="nowrap">
	                              <select id="pquarters"  name="form.retrieveSO.pquarters" class="inp"">
	                              	  <option value="">请选择</option>
                              ...
                              <td width="15%;" nowrap="nowrap">
	                              <select id="unitlvl" name="form.retrieveSO.unitlvl" class="inp"">
	                              	  <option value="">请选择</option>
                              ...
                              <td width="15%;" nowrap="nowrap">
	                              <select id="harvestLevel" name="form.retrieveSO.harvestLevel" class="inp"">
	                              	  <option value="">请选择</option>
