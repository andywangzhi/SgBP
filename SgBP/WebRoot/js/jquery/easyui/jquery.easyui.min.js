...
//added by ykchow  for get current page on Jun 26 2011
if (document.frm !=undefined  )
	{
	if ( document.frm.currpage!=undefined)
		 document.frm.currpage.value=_67;;
 }
};
function _68(_69){
...
$.fn.pagination.defaults={total:1,pageSize:10,pageNumber:1,pageList:[10,20,30,50,100],loading:false,buttons:null,showPageList:true,showRefresh:true,onSelectPage:function(_75,_76){
