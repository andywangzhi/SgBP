$(function(){
	...
	$('#tabs').tabs('add',{
		title:'人员管理',
		content:createFrame(basePath+'/soa/user!viewFind.action?menuId=22','人员管理')
	}).tabs({
    ...
    if(_menus == undefined || _menus == null || _menus == '' ){
       ...
       location.href = basePath+'/logout.action';
	    ...
	    $.each(_menus.menus, function(i, n) {
	        ...
	        menulist += '<li><div style="text-align:left" title="'+n.menuname+'"><a ref="' + o.menuid + '" href="#" rel="' + o.url + '" ><img border="0" src="../images/' + o.icon + '.gif" /><span class="nav">' + o.menuname + '</span></a></div></li> ';
	        })
			menulist += '</ul>';
