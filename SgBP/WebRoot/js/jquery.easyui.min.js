...
},promptforpassword:function(_211,msg,fn){
var _212="<div class=\"messager-icon messager-question\"></div>"+"<div>"+msg+"</div>"+"<br/>"+"<input class=\"messager-input\" type=\"password\"/>"+"<div style=\"clear:both;\"/>";
var _213={};
_213[$.messager.defaults.ok]=function(){
win.window("close");
if(fn){
