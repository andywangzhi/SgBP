...
public class BaseService {
	 ...
	 * @throws Exception
	 */
	protected com.gmcc.support.trade.service.provider.rcsm.need.RsPersonneedServiceSoapBindingStub initRsPersonneedStub () throws Exception{
        com.gmcc.support.trade.service.provider.rcsm.need.RsPersonneedServiceSoapBindingStub binding;
        com.gmcc.support.trade.service.provider.rcsm.need.RsPersonneedServiceLocator serviceLocator = new com.gmcc.support.trade.service.provider.rcsm.need.RsPersonneedServiceLocator();
		String serviceUrl = this.getPropertieValue("config/webservice.properties", "RsPersonneedProxyService");
		serviceLocator.setRsPersonneedServicePortEndpointAddress(serviceUrl);
		binding = (com.gmcc.support.trade.service.provider.rcsm.need.RsPersonneedServiceSoapBindingStub)serviceLocator.getRsPersonneedServicePort();
