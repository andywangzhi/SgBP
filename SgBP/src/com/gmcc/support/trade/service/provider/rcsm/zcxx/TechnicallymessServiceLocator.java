...
public class TechnicallymessServiceLocator extends org.apache.axis.client.Service implements com.gmcc.support.trade.service.provider.rcsm.zcxx.TechnicallymessService {
    ...
    public com.gmcc.support.trade.service.provider.rcsm.zcxx.ITechnicallymessService getTechnicallymessServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.gmcc.support.trade.service.provider.rcsm.zcxx.ITechnicallymessService getTechnicallymessServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.gmcc.support.trade.service.provider.rcsm.zcxx.TechnicallymessServiceSoapBindingStub _stub = new com.gmcc.support.trade.service.provider.rcsm.zcxx.TechnicallymessServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.gmcc.support.trade.service.provider.rcsm.zcxx.ITechnicallymessService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.gmcc.support.trade.service.provider.rcsm.zcxx.TechnicallymessServiceSoapBindingStub _stub = new com.gmcc.support.trade.service.provider.rcsm.zcxx.TechnicallymessServiceSoapBindingStub(new java.net.URL(TechnicallymessServicePort_address), this);
                _stub.setPortName(getTechnicallymessServicePortWSDDServiceName());
                return _stub;
            }
        }
