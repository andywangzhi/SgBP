...
public class EducationexperienceServiceLocator extends org.apache.axis.client.Service implements com.gmcc.support.trade.service.provider.rcsm.jyjl.EducationexperienceService {
    ...
    public com.gmcc.support.trade.service.provider.rcsm.jyjl.IEducationexperienceService getEducationexperienceServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.gmcc.support.trade.service.provider.rcsm.jyjl.IEducationexperienceService getEducationexperienceServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.gmcc.support.trade.service.provider.rcsm.jyjl.EducationexperienceServiceSoapBindingStub _stub = new com.gmcc.support.trade.service.provider.rcsm.jyjl.EducationexperienceServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.gmcc.support.trade.service.provider.rcsm.jyjl.IEducationexperienceService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.gmcc.support.trade.service.provider.rcsm.jyjl.EducationexperienceServiceSoapBindingStub _stub = new com.gmcc.support.trade.service.provider.rcsm.jyjl.EducationexperienceServiceSoapBindingStub(new java.net.URL(EducationexperienceServicePort_address), this);
                _stub.setPortName(getEducationexperienceServicePortWSDDServiceName());
                return _stub;
            }
        }
