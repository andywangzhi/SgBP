...
public class WorkexperienceServiceTestCase extends junit.framework.TestCase {
    ...
    public void testWorkexperienceServicePortWSDL() throws Exception {
        ...
        java.net.URL url = new java.net.URL(new com.gmcc.support.trade.service.provider.outrcsm.gzjl.WorkexperienceServiceLocator().getWorkexperienceServicePortAddress() + "?WSDL");
        javax.xml.rpc.Service service = serviceFactory.createService(url, new com.gmcc.support.trade.service.provider.outrcsm.gzjl.WorkexperienceServiceLocator().getServiceName());
    ...
    public void test1WorkexperienceServicePortAcceptSaveWorkexperience() throws Exception {
        ...
        try {
            binding = (com.gmcc.support.trade.service.provider.outrcsm.gzjl.WorkexperienceServiceSoapBindingStub)
                          new com.gmcc.support.trade.service.provider.outrcsm.gzjl.WorkexperienceServiceLocator().getWorkexperienceServicePort();
        }
        ...
        // Test operation
        int value = -3;
        value = binding.acceptSaveWorkexperience(new com.gmcc.support.trade.service.provider.outrcsm.gzjl.WorkexperienceVo());
    ...
    public void test2WorkexperienceServicePortAcceptQueryWorkexperience() throws Exception {
        ...
        // Test operation
        com.gmcc.support.trade.service.provider.outrcsm.gzjl.WorkexperienceVo[] value = null;
        value = binding.acceptQueryWorkexperience(new com.gmcc.support.trade.service.provider.outrcsm.gzjl.WorkexperienceQo());
        // TBD - validate results
    }
