...
public class RsPersonTypeServiceLocator extends org.apache.axis.client.Service implements com.gmcc.support.trade.service.provider.outrcsm.rctj.RsPersonTypeService {
    ...
    public com.gmcc.support.trade.service.provider.outrcsm.rctj.IRsPersonTypeService getRsPersonTypeServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.gmcc.support.trade.service.provider.outrcsm.rctj.IRsPersonTypeService getRsPersonTypeServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.gmcc.support.trade.service.provider.outrcsm.rctj.RsPersonTypeServicePortBindingStub _stub = new com.gmcc.support.trade.service.provider.outrcsm.rctj.RsPersonTypeServicePortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.gmcc.support.trade.service.provider.outrcsm.rctj.IRsPersonTypeService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.gmcc.support.trade.service.provider.outrcsm.rctj.RsPersonTypeServicePortBindingStub _stub = new com.gmcc.support.trade.service.provider.outrcsm.rctj.RsPersonTypeServicePortBindingStub(new java.net.URL(RsPersonTypeServicePort_address), this);
                _stub.setPortName(getRsPersonTypeServicePortWSDDServiceName());
                return _stub;
            }
        }
