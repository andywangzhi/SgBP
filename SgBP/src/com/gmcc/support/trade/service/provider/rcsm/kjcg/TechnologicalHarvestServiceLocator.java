...
public class TechnologicalHarvestServiceLocator extends org.apache.axis.client.Service implements com.gmcc.support.trade.service.provider.rcsm.kjcg.TechnologicalHarvestService {
    ...
    public com.gmcc.support.trade.service.provider.rcsm.kjcg.ITechnologicalHarvestService getTechnologicalHarvestServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.gmcc.support.trade.service.provider.rcsm.kjcg.ITechnologicalHarvestService getTechnologicalHarvestServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.gmcc.support.trade.service.provider.rcsm.kjcg.TechnologicalHarvestServiceSoapBindingStub _stub = new com.gmcc.support.trade.service.provider.rcsm.kjcg.TechnologicalHarvestServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.gmcc.support.trade.service.provider.rcsm.kjcg.ITechnologicalHarvestService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.gmcc.support.trade.service.provider.rcsm.kjcg.TechnologicalHarvestServiceSoapBindingStub _stub = new com.gmcc.support.trade.service.provider.rcsm.kjcg.TechnologicalHarvestServiceSoapBindingStub(new java.net.URL(TechnologicalHarvestServicePort_address), this);
                _stub.setPortName(getTechnologicalHarvestServicePortWSDDServiceName());
                return _stub;
            }
        }
