...
public class TechnicallymessServiceTestCase extends junit.framework.TestCase {
    ...
    public void testTechnicallymessServicePortWSDL() throws Exception {
        ...
        java.net.URL url = new java.net.URL(new com.gmcc.support.trade.service.provider.outrcsm.zcxx.TechnicallymessServiceLocator().getTechnicallymessServicePortAddress() + "?WSDL");
        javax.xml.rpc.Service service = serviceFactory.createService(url, new com.gmcc.support.trade.service.provider.outrcsm.zcxx.TechnicallymessServiceLocator().getServiceName());
    ...
    public void test1TechnicallymessServicePortAcceptTechnicallymessDetail() throws Exception {
        ...
        try {
            binding = (com.gmcc.support.trade.service.provider.outrcsm.zcxx.TechnicallymessServiceSoapBindingStub)
                          new com.gmcc.support.trade.service.provider.outrcsm.zcxx.TechnicallymessServiceLocator().getTechnicallymessServicePort();
        }
        ...
        // Test operation
        com.gmcc.support.trade.service.provider.outrcsm.zcxx.TechnicallymessVo value = null;
    ...
    public void test3TechnicallymessServicePortAcceptSaveTechnicallymess() throws Exception {
        ...
        // Test operation
        int value = -3;
        value = binding.acceptSaveTechnicallymess(new com.gmcc.support.trade.service.provider.outrcsm.zcxx.TechnicallymessVo());
        // TBD - validate results
    }
